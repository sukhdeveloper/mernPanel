...
const TrafficPerCategory = props => {
...
TrafficPerCategory.defaultProps = {
  height: 200,
  labels: ['mern2', 'ECO', 'Tech', 'Design', 'Business', 'Fashion', 'Luxury', 'Keynotes'],
...
const TrafficPerCategoryTransparent = props => {
...
const TrafficPerCategoryGrad = props => {
  const { labels, datasets, options, height, layout } = props;
  const data = {
    labels,
    datasets,
...
TrafficPerCategoryGrad.defaultProps = {
  labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
  datasets: [
    {
      data: [20, 60, 50, 45, 50, 60, 70, 40, 45, 35, 25, 30],
