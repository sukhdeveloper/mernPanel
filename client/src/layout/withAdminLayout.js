            ...
            >
              <Row>
                <Col lg={!topMenu ? 4 : 3} sm={6} xs={12} className="align-center-v navbar-brand">
                  ...
                  >
                    <img
                      src={!darkMode ? require(`../static/img/53logo.8302e4fd.8302e4fd.png`) : require(`../static/img/53logo.8302e4fd.8302e4fd.png`)}
                      alt=""
                    />
                  </Link>
                </Col>
              ...
              <Layout className="atbd-main-layout">
                <Content>
                  ...
                  <Footer className="admin-footer" style={footerStyle}>
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="admin-footer__copyright">2022 © The mern2 pr</span>
                      </Col>
                      {/* <Col md={12} xs={24}>
