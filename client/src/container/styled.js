...
const SidebarFormWrapper = Styled.div`
   .mdl-sidebar{
    display:inline-flex;
    align-items:center;
   }
...
.sidebar-table table thead th:first-child {
    border-radius: 10px 0 0 10px !important;
}
.sidebar-table table thead th:last-child {
    border-radius: 0 10px 10px 0 !important;
}
.sidebar-table table thead th:nth-child(3) {
    text-align: right;
}
.sidebar-table table tbody tr td:nth-child(3) {
    text-align: right;
}
...
.sidebar-table table tbody tr:hover td {
    background-color: #fff !important;
}
.sidebar_table_info p {
    margin-bottom: 0px;
    color: #000;
    font-weight: 500;
}
.action_for_sidebar_list svg {
    width: 18px;
}
.addimage-listdesign {
    display: flex;
...
.addimage-listdesign .image-sect{
    width: 30%;
    margin-right:15px;
}
.addimage-listdesign .imagetext-sect{
    margin-right:15px;
    width: 30%;
}
.addimage-listdesign .imageurl-sect{
    width: 30%;
    margin-right:15px;
}
.image-side-button .ant-upload.ant-upload-select.ant-upload-select-text{
    width:100% !important;
}
.image-side-button button.ant-btn {
    width: 100% !important;
}
.imagetext-sect input {
...
.full_width_accor_section {
    display: flex;
    width: 100% !important;
    margin-bottom: 15px;
}
.full_width_accor_section .ant-collapse.ant-collapse-icon-position-left {
    width: 98%;
    margin-right:20px;
}
.full_width_accor_section .ant-collapse-header {
    padding-top: 5px !important;
    padding-bottom: 5px !important;
}
.full_width_accor_section span.anticon.anticon-right.ant-collapse-arrow {
    padding-top: 6px !important;
}
.sidebar-items-form input[type='text'] {
    padding: 5px 11px !important;
}
.sectionaccor-info .ant-collapse-header {
    font-weight: 600;
}
.sidebar-items-form .ant-col.ant-form-item-label {
    padding-bottom: 0px;
}
`;

const EnquiriesFormWrapper = Styled.div`
.enquiries-top-options button:not(:last-child) {
    margin-right: 15px;
}
`;

const MediaFormWrapper = Styled.div`
.w-100{
    width: 100%;
}
.media_new_image {
...
const EventsFormWrapper = Styled.div`
    ...
    .sDash_export-file-table .ant-table-content .ant-table-thead {
        border: 1px solid #F1F2F6;
        border-radius: 10px;
    }
    .sDash_export-file-table .ant-table-content .ant-table-thead tr th {
        background-color: #F8F9FB;
        border: 0 none;
        font-weight: 600;
        color: #000000;
    }
    .sDash_export-file-table .ant-table-content .ant-table-thead tr th:first-child {
        border-radius: 10px 0 0 10px;
    }
    .sDash_export-file-table .ant-table-content .ant-table-thead tr th:last-child {
        border-radius: 0 10px 10px 0;
    }
    .sDash_export-file-table {
        margin-top: 24px;
    }
    .sDash_export-file-table .ant-table-content .ant-table-tbody tr td {
        border: 0 none;
        padding: 10px;
        background-color: #fff;
    }
    .sDash_export-file-table .ant-table-content .ant-table-tbody tr:hover td {
        background-color: #fff !important;
    }
    .action_for_event_list svg.feather {
        width: 18px;
        color: #000;
        margin: 5px;
    }
    .events_options-beneath .ant-anchor-ink:before {
        content: unset;
        width: 0px;
    }
    .events_options-beneath .ant-anchor{
       padding-left:0px;
    }
    .events_options-beneath .ant-anchor {
        display: inline-flex;
    }
    .events_options-beneath .ant-anchor-link{
        padding:0px !important;
    }
    .events_options-beneath .ant-anchor .ant-anchor-link:not(:last-child) {
        margin-right: 5px;
    }
    .events_table_records p {
        margin-bottom: 0px;
        font-weight: 500;
    }
    .sDash_form-action{
