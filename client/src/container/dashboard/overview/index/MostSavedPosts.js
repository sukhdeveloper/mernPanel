  ...
  return (
    <CardGroup>
      <div className="full-width-table">
        <Cards
          title="Top 10 Most Saved Trends"
          size="large"
        >
