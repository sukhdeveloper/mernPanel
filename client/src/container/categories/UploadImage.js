...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      featureImagesIdsArray:
        props.featureImagesIdsArray && props.featureImagesIdsArray.length > 0 ? props.featureImagesIdsArray : [],
      multipleUploads: props.limitOfImageUpload ? props.limitOfImageUpload : 8,
      // fileList: [
      //   {
      //     uid: '-1',
      //     name: 'image.png',
  ...
  render() {
    ...
    return (
      <>
        <Upload
          ...
          onChange={e => {
            ...
            if (completeData.file.status == 'done') {
              ...
              this.setState({
                featureImagesIdsArray: this.state.featureImagesIdsArray.filter((s, sindex) => index !== sindex),
              });
        ...
        >
          {fileList.length >= this.state.multipleUploads ? null : uploadButton}
        </Upload>
